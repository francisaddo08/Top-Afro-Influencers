...
namespace Afro.Ranking.Persistance.Migrations
{
    ...
    [Migration("20241115135411_AddTitok")]
    partial class AddTitok
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Afro.Ranking.Domain.Entities.TikTok", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Afro.Ranking.Domain.Entities.TikTok", b =>
                {
                    b.HasOne("Afro.Ranking.Domain.Entities.Influencer", null)
                        .WithOne("TikTok")
                        .HasForeignKey("Afro.Ranking.Domain.Entities.TikTok", "InfluencerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
